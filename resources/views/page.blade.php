...
<head>
    ...
    <link
        ...
        rel="stylesheet" />
    <!-- Apple Touch Icon -->
    <link rel="apple-touch-icon" sizes="180x180" href="{{ Vite::asset('favicon_package/apple-touch-icon.png') }}">

    <!-- Favicon para diferentes tamanhos -->
    <link rel="icon" type="image/png" sizes="32x32" href="{{ Vite::asset('favicon_package/favicon-32x32.png') }}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ Vite::asset('favicon_package/favicon-16x16.png') }}">

    <!-- Manifesto para PWA (Progressive Web App) -->
    <link rel="manifest" href="{{ Vite::asset('favicon_package/site.webmanifest') }}">

    <!-- Safari Pinned Tab Icon -->
    <link rel="mask-icon" href="{{ Vite::asset('favicon_package/safari-pinned-tab.svg') }}" color="#5bbad5">
    ...
    <link rel="shortcut icon" href="{{ Vite::asset('favicon_package/favicon.ico') }}">
